...
public class LogAspect {
	...
	@Pointcut("@annotation(cn.jeefast.common.annotation.LogForRest)")
	...
	private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
		...
		LogForRest log = method.getAnnotation(LogForRest.class);
		...
		if(log != null){
			...
			if("settingInfo".equals(methodName)) {
				...
				String paramType = String.valueOf(paramMap.get("settingType"));
		...
		sysLog.setUsername(String.valueOf(args[1]));
