...
var vm = new Vue({
	...
	methods: {
		...
		add: function(){
			...
			vm.roleList = {};
			vm.alarmTypeList={};
			vm.user = {deptName:null, deptId:null, status:1, roleIdList:[], alarmIdList:[],userType:1};
		...
		getRoleList: function(){
			$.get(baseURL + "sys/role/select",{roleType:'1'}, function(r){
				vm.roleList = r.list;
			});
		},
		...
		reload: function () {
			...
			$("#jqGrid").jqGrid('setGridParam',{ 
                postData:{'username': vm.q.username,'userType':1},
                page:page
            }).trigger("reloadGrid");
		}
	},
