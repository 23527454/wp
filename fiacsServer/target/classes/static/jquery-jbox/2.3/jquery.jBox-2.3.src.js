...
(function ($) {
    $.jBox = function (content, options) {
        ...
        boxHtml.push('<div class="jbox-help-title jbox-title-panel" style="height:42px;display:none;"></div>');
        boxHtml.push('<div class="jbox-help-button jbox-button-panel" style="height:36px;padding:5px 0 5px 0;display:none;"></div>');
