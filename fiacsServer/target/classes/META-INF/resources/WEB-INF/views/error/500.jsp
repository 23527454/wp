...
<body>
	<div class="container-fluid">
		...
		<div class="errorMessage">
			...
			<a href="javascript:" onclick="$('.errorMessage').toggle();$('.errorMessageDetail').toggle();" class="btn">查看详细信息</a>
		</div>
		<div class="errorMessageDetail" style="display: none;">
			<%=StringUtils.toHtml(sb.toString())%> <br/>
			<a href="javascript:" onclick="history.go(-1);" class="btn">返回上一页</a> &nbsp;
			<a href="javascript:" onclick="$('.errorMessage').toggle();$('.errorMessageDetail').toggle();" class="btn">隐藏详细信息</a>
			<br/> <br/>
		</div>
