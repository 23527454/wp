...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/guard/carEventQuery/">车辆事件查询列表</a></li>
		<li class="active"><a href="${ctx}/guard/carEventQuery/form?id=${carEventQuery.id}">车辆事件查询<shiro:hasPermission name="guard:carEventQuery:edit">${not empty carEventQuery.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="guard:carEventQuery:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="carEventQuery" action="${ctx}/guard/carEventQuery/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-group">
			<div class="col-xs-offset-2 col-xs-10">
				<shiro:hasPermission name="guard:carEventQuery:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
