...
<head>
	...
	<link rel="stylesheet" href="${ctxStatic}/calendar/css/calendar.css">
	<link rel="stylesheet" href="${ctxStatic}/calendar/css/amazeui.min.css">
	<link rel="stylesheet" href="${ctxStatic}/calendar/css/timedropper.css">
	<script src="http://www.jq22.com/jquery/jquery-1.10.2.js"></script>
	<script src="https://cdn.bootcss.com/amazeui/2.7.2/js/amazeui.min.js" charset="utf-8"></script>
	<script src="${ctxStatic}/calendar/js/timedropper.js" charset="utf-8"></script>
	<script src="${ctxStatic}/calendar/js/calendar.js" charset="utf-8"></script>
...
<ul class="nav nav-tabs">
	<li class="active"><a href="${ctx}/access/defenseParaInfo/">工作日列表</a></li>
</ul>
