	...
	<div id="content" class="row-fluid">
		<div id="left" class="accordion-group">
			<div class="accordion-heading">
				<a class="accordion-toggle">班组列表<i
			...
			<input htmlEscape="false" id="classTaskfo_id"
				class="input-xlarge required" style="display: none" /> <input
				htmlEscape="false" id="classTaskfo_name"
				class="input-xlarge required" style="display: none" />
		</div>
		<div id="openClose" class="close">&nbsp;</div>
		<div id="right">
			<iframe id="officeContent" src="${ctx}/guard/taskScheduleInfo/list"
			...
			callback : {
				onClick : function(event, treeId, treeNode) {
					...
					$('#officeContent')
							.attr(
									"src",
									"${ctx}/guard/taskScheduleInfo/list?classTaskId=" + id);
					$('#classTaskfo_id').val(id);
					$('#classTaskfo_name').val(treeNode.name);
				}
			}
		};

		function refreshTree() {
			$.getJSON("${ctx}/guard/classTaskInfo/treeData?time="+new Date(), function(data) {
