...
<div class="container-fluid">
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/mj/defenseParaInfo/">防区信息列表</a></li>
		<li class="active"><a
				href="${ctx}/mj/defenseParaInfo/form?id=${defenseParaInfo.id}">防区信息</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="defenseParaInfo"
			   action="${ctx}/mj/defenseParaInfo/save" method="post"
	...
	<div class="form-group">
		...
		<div class="form-group">
			<div class="col-xs-offset-2 col-xs-10">
				...
				<a id="btnCancel" href="${ctx}/mj/defenseParaInfo/" class="btn btn-default" >返回</a>
			</div>
		</div>
	</form:form>
</div>
