...
<div class="container-fluid">
    <ul class="nav nav-tabs">
        <li><a href="${ctx}/mj/securityParaInfo/">防盗信息列表</a></li>
        <li class="active"><a
                href="${ctx}/mj/securityParaInfo/form?id=${securityParaInfo.id}">防盗信息</a></li>
    </ul>
    <br/>
    <form:form id="inputForm" modelAttribute="securityParaInfo"
               action="${ctx}/mj/securityParaInfo/save" method="post"
...
<div class="form-group">
    <div class="col-xs-offset-2 col-xs-10">
        <shiro:hasPermission name="mj:securityParaInfo:edit">
            <input id="btnSubmit" class="btn btn-primary" type="submit"
                   value="保 存"/>&nbsp;</shiro:hasPermission>
        <a id="btnCancel" href="${ctx}/mj/securityParaInfo/" class="btn btn-default">返回</a>
    </div>
</div>
</form:form>
</div>
