...
<div class="container-fluid">
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/guard/safeGuardEvent/list?nodes=${safeGuardEvent.nodes}">维保员事件列表</a></li>
		<li class="active"><a
			href="${ctx}/guard/safeGuardEvent/form?id=${safeGuardEvent.id}&nodes=${safeGuardEvent.nodes}">维保员事件查看</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="safeGuardEvent"
		action="${ctx}/guard/safeGuardEvent/save" method="post"
		...
		<div class="row">
			<div class="col-xs-7">
				...
				<%-- <div class="form-group">
					...
					<div class="col-xs-6">
						<form:input path="eventType" htmlEscape="false" maxlength="32"
							...
							value="${fns:getDictLabel(safeGuardEvent.eventType, 'event_type', '')}" />
					</div>
				</div> --%>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-xs-6">
						<a rel="popover" data-img="${ctx}/guard/image?id=${safeGuardEvent.eventDetailId}">
							<img src="${ctx}/guard/image?id=${safeGuardEvent.eventDetailId}" style="width: 200px; height: 126px" class="img-thumbnail"/>
						</a>
					</div>
				</div>
				<div class="form-group">
