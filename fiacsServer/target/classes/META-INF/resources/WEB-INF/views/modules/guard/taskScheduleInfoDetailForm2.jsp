			...
			<div class="col-xs-6">
				...
				<div class="form-group">
					<table class="table table-striped table-bordered table-condensed"
						...
						<thead>
							<tr>
								<th data-options="field:'cardNum'" width="100%">节点名称</th>
							</tr>
						</thead>
						<tbody>
						<%-- <tr>
									<td>${taskScheduleInfoDetail.officeName}</td>
								</tr> --%>
							<c:forEach
				...
				<div class="form-group">
					<table class="table table-striped table-bordered table-condensed"
						...
						<thead>
							<tr>
								<th data-options="field:'staffName'" width="100%">押款员名称</th>
							</tr>
						</thead>
						<tbody>
						
							<c:forEach items="${taskScheduleInfoDetail.eventDetailList}"
								var="staffMe">
								<c:if test="${staffMe.staff!=null}">
								<tr>
									<td>${staffMe.staff.name}</td>
								</tr>
								</c:if>
							</c:forEach>
						</tbody>
