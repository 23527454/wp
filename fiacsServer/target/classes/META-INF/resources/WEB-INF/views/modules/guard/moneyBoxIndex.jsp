...
<!-- 				<div class="form-group"> -->
					<div id="search" class="input-group" style="padding:10px 0 0 10px;">
						...
						<span class="input-group-btn">
							<button type="button" class="btn btn-default btn-sm" id="btn" onclick="searchNode()"><i class="glyphicon glyphicon-search"></i></button>
						</span>
					</div>
<!-- 	 			</div> -->
<!--  			</form> -->
		...
		<div id="right">
			<iframe id="officeContent" src="${ctx}/guard/moneyBox/list"
	...
	var key, lastValue = "",  nodeList = [], type = getQueryString("type", "${url}");
		var tree, setting = {
			...
			callback : {
				onClick : function(event, treeId, treeNode) {
					...
					$('#officeContent').attr(
							"src",
							"${ctx}/guard/moneyBox/list?office.id=" + id);
					$('#office_id').val(id);
		...
		function refreshTree() {
			$.getJSON("${ctx}/sys/office/treeData?time="+new Date(), function(data) {
