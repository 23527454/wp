...
public class DefenseParaInfo extends DataEntity<DefenseParaInfo> {
	...
	public DefenseParaInfo(Integer defensePos, Integer defenseAreaType, String defenseAreaBypass, Integer defenseAreaAttr, Integer alarmDelayTime, String timeframe) {
