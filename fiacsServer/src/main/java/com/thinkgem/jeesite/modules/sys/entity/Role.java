...
//	private List<User> userList = Lists.newArrayList(); // 拥有用户列表
	...
	public static final String DATA_SCOPE_ALL = "1";//所有前端机
	public static final String DATA_SCOPE_AREA_AND_CHILD = "2";//区域内所有前端机
	public static final String DATA_SCOPE_OFFICE_AND_CHILD = "3";//网点机构内所有前端机
