...
public class Page<T> {
	...
	public Page(HttpServletRequest request, HttpServletResponse response, int defaultPageSize){
		...
		if(defaultPageSize == -1){
			String MAX_QUERY_SIZE = "100000";//最大导出
			CookieUtils.setCookie(response, "pageSize", MAX_QUERY_SIZE);
			this.setPageSize(Integer.parseInt(MAX_QUERY_SIZE));
	...
	public String toString() {
		...
		sb.append("<li class=\"controls\"><span class=\"disabled input-group\" >当前 ");
