	...
	<div id="content" class="row-fluid">
		<div id="left" class="accordion-group">
			<div class="accordion-heading">
				<a class="accordion-toggle">公司列表<i
			...
			<input htmlEscape="false" id="company_id"
				class="input-xlarge required" style="display: none" /> <input
				htmlEscape="false" id="company_shortName"
				class="input-xlarge required" style="display: none" />
		</div>
		<div id="openClose" class="close">&nbsp;</div>
		<div id="right">
			<iframe id="officeContent" src="${ctx}/guard/car/list"
	...
	var tree, setting = {
			...
			callback : {
				onClick : function(event, treeId, treeNode) {
					...
					$('#officeContent').attr(
							"src",
							"${ctx}/guard/car/list?company.id=" + id);
					$('#company_id').val(id);
					$('#company_shortName').val(treeNode.name);
				}
			}
		};

		function refreshTree() {
			$.getJSON("${ctx}/guard/company/treeData?time="+new Date(), function(data) {
