...
<div class="container-fluid">
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/guard/doorInOutEventQuery/list">门禁出入事件列表</a></li>
		<li class="active"><a
			href="${ctx}/guard/doorInOutEventQuery/form?id=${doorInOutEventQuery.id}">门禁出入事件查看</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="doorInOutEventQuery"
		action="${ctx}/guard/doorInOutEventQuery/save" method="post"
				...
				<div class="form-group">
					...
					<div class="col-xs-6">
						<form:input path="doorPos" htmlEscape="false"
							class="form-control input-sm required"
							value="${fns:getDictLabel(doorInOutEventQuery.doorPos, 'door_pos', '')}" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-xs-6">
						<form:input path="accessStatus" htmlEscape="false"
							class="form-control input-sm required"
							value="${fns:getDictLabel(doorInOutEventQuery.accessStatus, 'door_access_status', '')}" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-xs-6">
						<form:input path="eventType" htmlEscape="false" maxlength="32"
							...
							value="${fns:getDictLabel(doorInOutEventQuery.eventType, 'door_control_event_type', '')}" />
					</div>
				</div>
				<div class="form-group">
			...
			<div class="form-group">
					...
					<div class="col-xs-6">
						<form:input path="handleStatus" htmlEscape="false" maxlength="32"
							class="form-control input-sm "
							value="${fns:getDictLabel(doorInOutEventQuery.handleStatus, 'door_handle_status', '')}" />
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-xs-6">
						<form:input path="handleMode" htmlEscape="false" maxlength="32"
							class="form-control input-sm "
							value="${fns:getDictLabel(doorInOutEventQuery.handleMode, 'door_control_handle_mode', '')}" />
					</div>
				</div>
				<div class="form-group">
				 ...
				 <div class="form-group">
					...
					<div class="col-xs-6">
						<a rel="popover" data-img="${ctx}/guard/image/image?id=${doorInOutEventQuery.eventDetailId}">
							<img src="${ctx}/guard/image?id=${doorInOutEventQuery.eventDetailId}" style="width: 200px; height: 126px" class="img-thumbnail"/>
						</a>
					</div>
				</div> 
						...
						<tbody>
							<c:forEach items="${connectEvent.eventDetailList}" var="delist" varStatus="varStatus">
								<tr>
									...
									<td>
									<a rel="popover" data-img="${ctx}/guard/image/image?id=${doorInOutEventQuery.eventDetailId}">
							<img src="${ctx}/guard/image/car?id=${doorInOutEventQuery.eventDetailId}" style="width: 100px; height: 100px" class="img-thumbnail"/>
						</a>
									</td>
								</tr>
							<!-- </c:forEach> -->
