...
<body>
	...
	<form:form id="inputForm" modelAttribute="role"
		...
		<div class="form-group" style="display: none">
			<label class="control-label col-sm-2">角色归属网点:</label>
			<div class="col-sm-3">
				<sys:treeselect id="office" name="office.id"
					value="${role.office.id}" labelName="office.name"
					labelValue="${role.office.name}" title="网点"
					url="/sys/office/treeData" cssClass="required" />
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-sm-2"><font color="red">*</font> 角色名称:</label>
			<div class="col-sm-3">
		...
		<div class="form-group" style="display: none">
			...
			<div class="col-sm-3">
				...
				<span class="help-inline"
					...
					角色类型（任务分配：assignment、管理角色：security-role、普通角色：user）</span>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-sm-2">是否系统数据:</label>
			<div class="col-sm-3">
				<form:select path="sysData"  cssStyle="width:160px;">
					<form:options items="${fns:getDictList('yes_no')}"
						itemLabel="label" itemValue="value" htmlEscape="false" />
				</form:select>
				<p class="help-block">
				“是”表此角色权限数据只有超级管理员能进行修改<br/>
				“否”则表示拥有角色修改人员的权限都能进行修改
				</p>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-3">
				<form:select path="useable" cssStyle="width:160px;">
					<form:options items="${fns:getDictList('yes_no')}"
						itemLabel="label" itemValue="value" htmlEscape="false" />
				</form:select>
				<p class="help-block">
		...
		<div class="form-group">
			<label class="control-label col-sm-2">设备授权:</label>
			<div class="col-sm-3">
		...
		<div class="form-group">
			<label class="control-label col-sm-2">功能授权:</label>
			<div class="col-sm-3">
				<div id="menuTree" class="ztree"
					style="margin-top: 3px; float: left; height: 300px;overflow:auto;"></div>
