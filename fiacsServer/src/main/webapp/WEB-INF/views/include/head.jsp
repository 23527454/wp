...
<link href="${ctxStatic}/metisMenu/dist/metisMenu.min.css" rel="stylesheet" />
<script src="${ctxStatic}/jquery-select2/4.0/js/select2.min.js" type="text/javascript"></script>
...
<script src="${ctxStatic}/metisMenu/dist/metisMenu.js" type="text/javascript"></script>
<link href="${ctxStatic}/common/jeesite.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/jeesite.js" type="text/javascript"></script>
<script type="text/javascript">var ctx = '${ctx}', ctxStatic='${ctxStatic}';</script>
<link href="${ctxStatic}/guard/main.css" rel="stylesheet" />
<script src="${ctxStatic}/guard/main.js" type="text/javascript"></script>