...
import com.xk.netty.util.FiacsServerWebSocketChannelMap;
...
@Component
@Sharable
public class FiacsServerWebSocketServerHandler extends SimpleChannelInboundHandler<Object> {

	/**
	 * 日志
	 */
	private static final Logger logger = Logger.getLogger(FiacsServerWebSocketServerHandler.class.getName());
	...
	private void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest request) {
		...
		FiacsServerWebSocketChannelMap.group.add(ctx.channel());
	...
	public void channelInactive(ChannelHandlerContext ctx) throws Exception {
		FiacsServerWebSocketChannelMap.group.remove(ctx.channel());
	}
